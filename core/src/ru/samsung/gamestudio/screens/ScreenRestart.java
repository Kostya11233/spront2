...
public class ScreenRestart implements Screen {
    ...
    public ScreenRestart(MyGdxGame myGdxGame, int score) {
        ...
        buttonRestart = new Buton(520, 400, 300, 110, "RESTART");
    ...
    public void render(float delta) {
        ...
        font.draw(myGdxGame.batch, "Your bird crashed into a tube...", MyGdxGame.SCR_WIDTH / 2f - 300, MyGdxGame.SCR_HEIGHT - 80);
        myGdxGame.batch.end();
    }
